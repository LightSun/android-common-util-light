...
common adapter
``` java
compile 'com.heaven7.core.adapter:adapter:1.5.5'
```
...
compile 'com.heaven7.core.util:util-extra:1.0'
 ...
 common ipc lib : latest debug
 ``` java
   //in client : 
  compile 'com.heaven7.android.ipc:ipc:2.1.2'
   //in server:  
  compile 'com.heaven7.android.ipc.server:ipc-server:1.1.2'
 ```
