...
public class WItemTouchHelperPlus extends RecyclerView.ItemDecoration
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                switch (swipeDir) {
                    ...
                    case END:
                        targetTranslateY = 0;
                        float swipeWidth = mCallback.getSwipeWidth(selected);
    ...
    private int checkHorizontalSwipe(RecyclerView.ViewHolder viewHolder, int flags) {
        if ((flags & (LEFT | RIGHT)) != 0) {
            ...
            if (SLIDE_ITEM_TYPE_ITEMVIEW.equals(mCallback.getItemSlideType())) {
                width += mCallback.getSwipeWidth(viewHolder);
            }
    ...
    public abstract static class Callback {
        ...
        public abstract int getSwipeWidth(RecyclerView.ViewHolder viewHolder);
    }
