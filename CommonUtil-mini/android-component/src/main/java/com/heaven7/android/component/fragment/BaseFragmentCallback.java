 ...
 */
public abstract class BaseFragmentCallback extends BaseFragmentCallback0 implements IFragmentCallback{
    ...
    @Override
    public void onActivityCreated(Bundle arguments, Bundle saveBundle) {
